...
// Define the network to use (devnet, testnet, mainnet-beta)
const network = new solana.Connection(solana.clusterApiUrl("devnet"));
// Create a new Metaplex client
const metaplex = new Metaplex(network);
